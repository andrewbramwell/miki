...
module.exports = function (eleventyConfig) {
	...
	// adds support for internationalisation (i18n)
	...
	// ignore the archive files to prevent excess pages when live
	eleventyConfig.ignores.add("./src/content/archive/**");
	...
	// filters navigation items to only those in the users current locale
	eleventyConfig.addFilter("navLocale", (navObj, currentLocale) =>
		navObj.filter((value) => value.locale === currentLocale)
	);
